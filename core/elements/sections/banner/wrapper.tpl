  ...
  <div class="container">
    <div class="swiper" data-swiper="banner">
      <div class="swiper-wrapper">
        {foreach [
            ['title'=>'Надёжность, проверенная временем','text'=>'Выбирая HORTON, вы выбираете качество, компетентность и чётко слаженный процесс от поступления заявки до выполнения поставки и работ на объекте.','image'=>'/assets/template/images/sections/banner.jpg','classes' => 'no-shadow'],
