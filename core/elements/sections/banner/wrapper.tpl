  ...
  <div class="container">
    <div class="swiper" data-swiper="banner">
      <div class="swiper-wrapper">
        {foreach [
            ['title'=>'Надёжность, проверенная временем','text'=>'Выбирая HORTON, вы выбираете качество, компетентность и чётко слаженный процесс от поступления заявки до выполнения поставки и работ на объекте.'],
            ['title'=>'Производство и поставка полимерных труб и фитингов','text'=>'Доставка по всей России, индивидуальная система скидок в зависимости от объема поставки.']
        ] as $slide}
