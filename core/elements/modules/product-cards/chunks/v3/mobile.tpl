<div class="product-card--v3 sm-d-block br-primary-small"  data-change-product="{$product['id']}" id="product_desktop_{$product['id']}">
    <label class="custom-checkbox fw-500">
        <input type="checkbox" data-change-id="product" value="{$product['id']}"/>
